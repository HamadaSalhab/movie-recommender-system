...
DATASET_DOWNLOAD_URL = "https://files.grouplens.org/datasets/movielens/ml-100k.zip"
DATASET_RAW_PATH_RELATIVE = '/../../data/raw/ml-100k.zip'
DATASET_RAW_PATH_ABSOLUTE = os.path.dirname(__file__) + DATASET_RAW_PATH_RELATIVE
DATASET_RAW_DIR_RELATIVE = '/../../data/raw/ml-100k/'
